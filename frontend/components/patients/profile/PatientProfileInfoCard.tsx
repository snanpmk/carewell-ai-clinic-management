      ...
      <div className="mt-8 space-y-4 text-left border-t border-slate-100 pt-6">
        ...
        <div className="flex items-center gap-4 text-sm group/item">
          ...
          <div>
            ...
            <p className="font-bold text-slate-800 tracking-tight">{patient.phone}</p>
          </div>
        </div>
        ...
        {patient.address && (
          <div className="flex items-center gap-4 text-sm group/item">
            ...
            <div>
              ...
              <p className="font-bold text-slate-800 tracking-tight text-balance leading-tight">{patient.address}</p>
            </div>
          </div>
        )}
      </div>
